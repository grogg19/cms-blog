	                    ...
	                    <?php if(!empty($pages)) { ?>
		                    ...
		                    <?php foreach ($pages as $page) { ?>
			                    <div class="row mb-6 mt-6" >
			                        ...
			                        <div class="col-lg-1"><a href="/admin/static-pages/edit" data-type="action" data-value="<?=$page->getFileName()['name']?>" data-action="/admin/static-pages/edit"><i class="fas fa-edit"></i></a></div>
			                        <div class="col-lg-1"><a href="/admin/static-pages/delete" data-type="action" data-value="<?=$page->getFileName()['name']?>" data-action="/admin/static-pages/delete"><i class="fas fa-times"></i></a></div>
			                    </div>
			                <?php } ?>
		                    </form>
	                    <?php } ?>
